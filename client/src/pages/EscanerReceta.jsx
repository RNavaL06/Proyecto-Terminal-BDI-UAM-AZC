...
export default function EscanerReceta() {
  ...
  const handleGuardarCajaEnBotiquin = async (e) => {
    ...
    try {
      ...
      toast.success('Medicamento guardado en tu botiquín.');
      navigate('/botiquin');
    } catch (err) {
  ...
  const handleGuardarReceta = async (formData) => {
    ...
    try {
      ...
      if (res.exito) {
        toast.success('Receta guardada exitosamente en el historial y botiquín.');
    ...
    <div className="max-w-3xl mx-auto px-3 sm:px-6 py-4 sm:py-8 space-y-6 animate-fade-in">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-xs sm:text-sm text-slate-500 max-w-md mx-auto">
          {activeTab === 'receta'
            ? 'Extrae prescripciones y diagnósticos médicos con Visión Artificial multimodal.'
            : 'Escanea el empaque para detectar nombre comercial, sustancia y fecha de caducidad.'}
        </p>
      </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm max-w-xl mx-auto space-y-6 text-center p-6 sm:p-8">
            ...
            {imagenSeleccionada ? (
              ...
              <div className="space-y-5">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-blue-50 text-[#497dfe] flex items-center justify-center mx-auto shadow-sm">
                ...
                <div className="flex flex-col gap-2.5 max-w-xs mx-auto pt-2">
                  ...
                  >
                    <Camera className="w-4 h-4 text-[#497dfe]" />
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm max-w-xl mx-auto space-y-6 text-center p-6 sm:p-8">
            ...
            {analizando ? (
              <div className="py-8 flex flex-col items-center justify-center space-y-3">
                <RefreshCw className="w-8 h-8 text-[#497dfe] animate-spin" />
            ...
            <form onSubmit={handleGuardarCajaEnBotiquin} className="space-y-3 text-left">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#497dfe]"
                />
              </div>
