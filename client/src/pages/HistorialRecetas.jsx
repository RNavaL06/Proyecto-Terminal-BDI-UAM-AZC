  ...
  return (
    <div className="max-w-5xl mx-auto px-3 sm:px-6 py-4 sm:py-8 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <span className="text-[11px] font-extrabold uppercase tracking-widest text-[#497dfe]">Expediente Clínico Digital</span>
      ...
      {loading ? (
            ...
            >
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <h3 className="text-base font-bold text-slate-800 group-hover:text-[#497dfe] transition-colors">
                      {rec.diagnostico || 'Receta Médica'}
                    </h3>
                    {rec.codigo_cie10 && (
                      <span className="inline-block text-[11px] font-extrabold bg-blue-50 text-[#497dfe] px-2.5 py-0.5 rounded-full border border-blue-200 mt-1">
              ...
              <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-xs font-semibold text-slate-500">
                <span className="flex items-center gap-1.5 text-[#497dfe] font-bold">
                  <Pill className="w-4 h-4" /> {rec.total_medicamentos || 0} fármacos prescritos
                </span>
                <span className="inline-flex items-center gap-1 text-slate-400 group-hover:text-[#497dfe] transition-colors font-bold">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 p-16 text-center space-y-3 shadow-sm">
          <div className="w-14 h-14 rounded-2xl bg-blue-50 text-[#497dfe] mx-auto flex items-center justify-center">
