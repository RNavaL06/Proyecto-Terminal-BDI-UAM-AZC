  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 animate-fade-in">
      ...
      <div className="bg-blue-50/70 border border-blue-200/80 rounded-3xl p-5 flex items-start gap-3.5">
        <ShieldCheck className="w-6 h-6 text-[#497dfe] flex-shrink-0 mt-0.5" />
        <div>
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-6 shadow-sm space-y-5">
        <h3 className="text-base font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
          <Pill className="w-5 h-5 text-[#497dfe]" /> Datos Generales de la Receta
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#497dfe] focus:bg-white transition-all"
            />
          </div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-[#497dfe] focus:bg-white transition-all resize-none"
          />
        </div>
      </div>
          ...
          {formData.medicamentos.map((med, idx) => (
            <div key={idx} className="p-4 bg-slate-50/70 border border-slate-200/80 rounded-2xl relative group">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-extrabold text-[#497dfe] bg-blue-50 px-2.5 py-0.5 rounded-full border border-blue-200">
                  Medicamento #{idx + 1}
                </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3.5 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#497dfe]"
                  />
                </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-5 shadow-sm">
        <label className="flex items-center gap-3 cursor-pointer select-none">
          <input
            ...
            onChange={handleChange}
            className="w-5 h-5 rounded-lg text-[#497dfe] focus:ring-[#497dfe] border-slate-300"
          />
          <div>
