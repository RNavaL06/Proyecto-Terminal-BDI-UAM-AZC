    ...
    <div className="bg-white rounded-3xl border border-slate-100 shadow-sm max-w-2xl mx-auto p-6 sm:p-8 space-y-6">
          ...
          <button
            ...
            className={`relative flex items-center justify-center w-20 h-20 rounded-full transition-all duration-300 shadow-lg ${
              permisoDenegado
                ...
                : 'bg-[#497dfe] text-white hover:bg-blue-600 shadow-blue-200/60'
            }`}
          >
            {listening && !permisoDenegado ? (
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#497dfe] focus:bg-white text-sm sm:text-base resize-none transition-all"
        />
      </div>
